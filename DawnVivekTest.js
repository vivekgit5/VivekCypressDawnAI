...
describe('Running Dawn Website Chatbot Automation', function () {
    ...
    cy.task("readExcel", {
      ...
      cy.window().then((win) => {
        win.chatbotConfig = {
          ...
          access_token: "eyJraWQiOiItS2hpSkJVMFRUQUg1UG9QNGxvVVN4dkxVbWpqeGZDNzhOUjl4QWVJeXFJIiwiYWxnIjoiUlMyNTYifQ..WgN9DUhEEw7bAH803cWljs5BrGiZcTuXaO0H-OiOYRfXwwxRdGpqawUqX0mfjwxZh5lXC_BHjA6T0EFUOySyepQoZhdXZ-Zz_nfb94idA6fD6iVMnZLILwWPe2gmRLBXnTmpXMA6Cwu7tX1RVgiJLQoNsIHLrDYYxRz4PtxA5-UEHebYKXUP_Sv7yYEmGoigH1gURCBZUiy8EmgZd8i7X-Qa33aig59J2lcvaue3hjyV3MzF1SOmWTdUzeOEIuDg1eFK1mI-xqOHc9zG-Dkcn21pt-U7q80vMtKkoE_pS5vRKFeyp_6zdPcifRIspJfRgpifZDBp9dPs9NjOgcsvUg" // Make sure the token is valid
        };
      });
  ...
  it('Run MTN evergreen queries in the chatbot and capture HTML responses', function () {
     // Reuse the helper function for setup
     cy.viewport(1221, 687);
      cy.visit(testUrl);
      cy.wait(5000); // Wait for the page to load completely
